...
return [
     ...
     */
    'payment'           => [
        'merchant_id' => env('WECHAT_PAYMENT_MERCHANT_ID', env('WECHAT_PAYMENT_MERCHANT_ID')),
        'key'         => env('WECHAT_PAYMENT_KEY', 'key-for-signature'),
        // 'cert_path'       => env('WECHAT_PAYMENT_CERT_PATH', 'path/to/your/cert.pem'),
        // 'key_path'        => env('WECHAT_PAYMENT_KEY_PATH', 'path/to/your/key'),
